...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("int", "BUILD_NUMBER", "89")
    }
    ...
    applicationVariants.all {
        ...
        outputs.all {
            ...
            output.outputFileName = "RandomRingtone-v${variant.versionName}-Michael_Jackson-Remember_The_Time-${variant.buildType.name}.apk"
        }
    }
